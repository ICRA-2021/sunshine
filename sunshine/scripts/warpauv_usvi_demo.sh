...
tmux split-window -v 'cd ~/warp_ws && source devel/setup.bash && sleep 2 && roslaunch sunshine warpauv_bag.launch robot_name:=warpauv_1 bagfile:=/data/2021-usvi/2021-10-25/surveys/warpauv_1_xavier1_2021-10-25-12-08-59.bag bag_start:=600 use_rviz:=true cell_size:=3600x1.2x1.2x15; bash'
