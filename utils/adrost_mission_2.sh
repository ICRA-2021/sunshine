...
tmux new-session -d -s foo 'roslaunch sunshine panama.launch rosbag:=/home/stewart/datasets/panama-bags/d20150404_3.bag image_topic:=camera/image_raw basename:=rost_1 || bash'
