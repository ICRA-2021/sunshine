...
tmux new-session -d -s foo 'roslaunch sunshine panama.launch rosbag:=/home/stewart/datasets/panama-bags/d20150419_19.bag image_topic:=camera/image_raw basename:=rost_1 || bash'
...
tmux split-window -h -t 0 'roslaunch sunshine panama.launch rosbag:=/home/stewart/datasets/panama-bags/d20150403_2.bag image_topic:=camera/image_raw basename:=rost_2 || bash'
