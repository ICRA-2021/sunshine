...
tmux split-window -v "roslaunch sunshine panama.launch $tm_args rosbag:=/home/stewart/datasets/panama-bags/d20150418_18.bag image_topic:=camera/image_raw basename:=rost_2 || bash"
